...
public class GlmUtil {
	 ...
	 * @param numFeature: number of features.
	 * @param familyLink: family and link function,
	 * @return DataSet: features, label, weight, offset, devianceResidual, pearResidual, workingResidual,
	 * responseResidual
	 */
	...
	public static DataSet <GlmModelSummary> aggSummary(DataSet <Row> residual, DataSet <WeightedLeastSquaresModel> model,
		...
		if (fitIntercept) {
			if (familyName.equals("Gaussian") && linkName.equals("Identity")) {
	 ...
	 */
	private static double devianceResiduals(FamilyFunction family, double label, double pred, double weight) {
	 ...
	 */
	private static double pearResiduals(FamilyFunction family, double label, double pred, double weight) {
	 ...
	 */
	private static double workingResiduals(LinkFunction link, double label, double pred, double weight) {
	...
	private static class NullProcMapFunc implements MapFunction <Row, Row> {
		...
		NullProcMapFunc(int numFeature) {
			this.numFeature = numFeature;
		}
	 ...
	 * weight stat.
	 */
	private static class WeightStat implements Serializable, AlinkSerializable {
